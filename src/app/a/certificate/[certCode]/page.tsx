    ...
    return (
      <div className="min-h-screen bg-[#030712]">
        <div className="mx-auto max-w-xl px-4 py-20 text-center sm:px-6">
          ...
          <h1 className="mb-3 text-2xl font-bold text-white">ไม่พบ Certificate</h1>
          <p className="mb-8 text-gray-400">
            รหัส Certificate &ldquo;{params.certCode}&rdquo; ไม่ถูกต้องหรือไม่มีในระบบ
          </p>
          <Link
            href="/"
    ...
    <div className="min-h-screen bg-[#030712]">
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
        ...
        <div className="mb-8 flex items-center justify-center gap-3 rounded-2xl border border-green-500/20 bg-green-500/5 px-6 py-4">
          ...
          <div>
            <p className="font-semibold text-green-400">Certificate ถูกต้อง</p>
          ...
          <div className="relative p-1">
            <div className="rounded-[22px] bg-[#0a1628] p-8 sm:p-12">
              ...
              <div className="mt-6 flex items-center justify-center gap-2 text-xs text-gray-500">
                ...
                <span>Certificate ถูกต้อง — ยืนยันโดย AI Business Academy</span>
              </div>
            </div>
          </div>
        </div>
