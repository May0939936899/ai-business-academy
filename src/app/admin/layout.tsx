...
const navItems = [
  ...
  { href: '/admin/lessons', label: 'บทเรียน', icon: PlayCircle },
  { href: '/admin/quizzes', label: 'แบบทดสอบ', icon: FileQuestion },
  { href: '/admin/users', label: 'ผู้ใช้งาน', icon: Users },
  { href: '/admin/certificates', label: 'Certificate', icon: Award },
  { href: '/admin/analytics', label: 'วิเคราะห์', icon: BarChart3 },
  { href: '/admin/content', label: 'เนื้อหาเว็บ', icon: Globe },
  ...
  if (!session) {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#030712]">
        <div className="flex flex-col items-center gap-4">
          <Loader2 className="h-8 w-8 animate-spin text-blue-500" />
          <p className="text-sm text-gray-400">กำลังนำไปหน้าเข้าสู่ระบบ...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#030712]">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-lg font-medium text-white">ไม่มีสิทธิ์เข้าถึง</p>
          <p className="text-sm text-gray-400">กำลังนำไปหน้า Dashboard...</p>
        </div>
      </div>
    )
  }
