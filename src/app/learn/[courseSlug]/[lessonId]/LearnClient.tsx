        ...
        <div className="mx-auto flex max-w-screen-2xl items-center justify-between px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className="hidden sm:inline">กลับไปหน้าคอร์ส</span>
            </Link>
        ...
        <div className="flex-1 p-4 lg:p-6">
          <div className="mb-4">
            <p className="mb-1 text-xs font-semibold uppercase tracking-wider text-blue-400">
              บทที่ {currentLesson.lessonOrder}
            </p>
          ...
          {currentLesson.description && (
            <div className="mb-8">
              <h3 className="mb-3 text-lg font-semibold text-white">รายละเอียดบทเรียน</h3>
          ...
          <div className="sticky top-14 max-h-[calc(100vh-56px)] overflow-y-auto">
            <div className="border-b border-white/[0.06] p-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-semibold text-white">เนื้อหาบทเรียน</h3>
              </div>
              <p className="mt-1 text-xs text-gray-500">
                {completedCount} จาก {totalLessons} บทเรียนเสร็จแล้ว
              </p>
            </div>
