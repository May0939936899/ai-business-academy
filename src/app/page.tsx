...
const features = [
  {
    ...
    description:
      "เนื้อหาทันสมัย ออกแบบมาเพื่อเรียนรู้การใช้ AI ในงานธุรกิจจริง",
  ...
  },
  {
    ...
    title: "Video Lessons",
    description:
      "วิดีโอบทเรียนคุณภาพสูง เข้าใจง่าย เรียนซ้ำได้ไม่จำกัดครั้ง",
  ...
  },
  {
    ...
    description:
      "ติดตามความก้าวหน้าแบบ Real-time เห็นพัฒนาการของตัวเองได้ชัดเจน",
  ...
  },
  {
    ...
    title: "Certificates",
    description:
      "ได้รับใบประกาศนียบัตรดิจิทัล ตรวจสอบได้จริง หลังเรียนจบแต่ละคอร์ส",
  ...
  },
  {
    ...
    description:
      "สอนโดยอาจารย์และผู้เชี่ยวชาญจากคณะบริหารธุรกิจ มหาวิทยาลัยศรีปทุม",
  ...
  },
  {
    ...
    title: "Free 100%",
    description:
      "คอร์สทั้งหมดเรียนฟรี ไม่มีค่าใช้จ่ายใดๆ เปิดโอกาสให้ทุกคน",
...
const learningPath = [
  {
    step: 1,
    title: "เรียนรู้พื้นฐาน AI",
    description:
      "ทำความเข้าใจ AI, Machine Learning และเครื่องมือ AI สมัยใหม่ เริ่มต้นจากศูนย์ได้ ไม่ต้องมีพื้นฐาน",
    icon: BookOpen,
    color: "from-blue-500 to-cyan-500",
  },
  {
    step: 2,
    title: "ประยุกต์ใช้ AI กับธุรกิจ",
    description:
      "นำ AI มาใช้จริงกับงาน HR, Marketing, Operations และ Management ผ่าน Workshop และ Case Study",
    icon: Zap,
    color: "from-purple-500 to-pink-500",
  },
  {
    step: 3,
    title: "เป็นผู้เชี่ยวชาญ AI Strategy",
    description:
      "วางแผนกลยุทธ์ AI สำหรับองค์กร เป็นผู้นำด้าน AI Transformation ที่ตลาดแรงงานต้องการ",
    icon: Target,
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid min-h-screen items-center gap-12 py-20 lg:grid-cols-2 lg:gap-16 lg:py-0">
            ...
            <div className="relative z-10 animate-slide-up">
              {/* Badge */}
              <div className="mb-8 inline-flex items-center gap-2.5 rounded-full border border-[#2196F3]/20 bg-[#2196F3]/5 px-5 py-2.5 backdrop-blur-sm">
                ...
                <span className="text-sm font-semibold text-[#4FC3F7]">
                  SPU BUS &middot; คณะบริหารธุรกิจ ม.ศรีปทุม
                </span>
              </div>
              ...
              {/* Subheadline */}
              <p className="mt-6 text-xl font-medium leading-relaxed text-gray-300 sm:text-2xl">
                แพลตฟอร์มเรียนรู้ AI สำหรับธุรกิจ
                <br />
                <span className="text-gray-500">
                  เพื่อพัฒนาทักษะสู่โลกการทำงานยุคใหม่
                </span>
              </p>

              {/* Description */}
              <p className="mt-4 max-w-lg text-base leading-relaxed text-gray-500">
                เรียนรู้การใช้ AI ในงานธุรกิจจริง ตั้งแต่พื้นฐานจนถึงระดับมืออาชีพ
                ผ่านบทเรียน วิดีโอ และแบบทดสอบ
              </p>
              ...
              <div className="relative h-[400px] w-[400px] sm:h-[480px] sm:w-[480px]">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative">
                    <div className="orb-1 absolute -inset-8 rounded-full bg-gradient-to-br from-[#2196F3]/20 to-[#E91E8C]/20 blur-2xl" />
                    <div className="relative flex h-32 w-32 items-center justify-center rounded-full bg-gradient-to-br from-[#2196F3] to-[#4FC3F7] shadow-2xl shadow-[#2196F3]/30">
                ...
                {/* Floating shapes */}
                <div className="orb-2 absolute left-4 top-16">
                  <div className="flex h-16 w-16 items-center justify-center rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-md">
                    <Zap className="h-7 w-7 text-yellow-400" />
                  </div>
                </div>
                <div className="orb-3 absolute right-4 top-24">
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-md">
                    <BarChart3 className="h-6 w-6 text-green-400" />
                  </div>
                </div>
                <div className="orb-1 absolute bottom-20 left-8">
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-md">
                    <Award className="h-6 w-6 text-purple-400" />
                  </div>
                </div>
                <div className="orb-2 absolute bottom-16 right-12">
                  <div className="flex h-16 w-16 items-center justify-center rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-md">
                ...
                {/* Small floating dots */}
                <div className="orb-3 absolute left-1/4 top-8 h-3 w-3 rounded-full bg-[#2196F3]/60" />
                <div className="orb-1 absolute right-1/4 top-12 h-2 w-2 rounded-full bg-[#E91E8C]/60" />
                <div className="orb-2 absolute bottom-12 left-1/3 h-2.5 w-2.5 rounded-full bg-[#4FC3F7]/60" />
                <div className="orb-3 absolute bottom-24 right-1/3 h-2 w-2 rounded-full bg-purple-400/60" />
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-gray-500">
              ...
              เรียนรู้ทักษะ AI ที่ใช้ได้จริงในโลกการทำงาน
            </p>
          </div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-gray-500">
              ออกแบบแพลตฟอร์มเพื่อประสบการณ์การเรียนรู้ที่ดีที่สุด
            </p>
          </div>
      ...
      <section className="relative border-t border-white/[0.04] bg-[#030712] py-28">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-gray-500">
              แดชบอร์ดส่วนตัวแสดงผลความก้าวหน้าแบบ Real-time
            </p>
          </div>
                ...
                {progressMock.map((item) => (
                  ...
                  >
                    ...
                    <p className="mt-2 text-xs text-gray-500">
                      {item.percent === 60
                        ? "6/10 บทเรียน สำเร็จแล้ว"
                        : "2/10 บทเรียน สำเร็จแล้ว"}
                    </p>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-6 flex items-center gap-3 rounded-2xl border border-yellow-500/20 bg-yellow-500/5 p-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-yellow-500/80">
                    AI Productivity for Modern Work &mdash; สำเร็จแล้ว
                  </p>
                </div>
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="mx-auto mt-5 max-w-xl text-gray-400">
                สมัครเรียนฟรี เรียนรู้ทักษะ AI ที่จำเป็นสำหรับคนทำงานยุคใหม่
